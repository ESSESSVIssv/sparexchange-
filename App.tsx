...
import { Product, Condition, Review, Currency, Conversation, ChatMessage, ToastMessage, Order, OrderStatus, Address } from './types';
import { generateDescription, generateChatReply } from './services/geminiService';
...
const mockLocations: Address[] = [
    { street: '123 Tech Ave', city: 'Silicon Valley', state: 'CA', zip: '94043', country: 'USA' },
    { street: '456 Commerce St', city: 'New York', state: 'NY', zip: '10001', country: 'USA' },
    { street: '789 Fashion Blvd', city: 'London', state: 'N/A', zip: 'W1J 9BR', country: 'UK' },
    { street: '101 Innovation Dr', city: 'Tokyo', state: 'N/A', zip: '100-0001', country: 'Japan' },
    { street: '212 Auto Row', city: 'Stuttgart', state: 'N/A', zip: '70173', country: 'Germany' },
    { street: '555 Market St', city: 'Mumbai', state: 'MH', zip: '400001', country: 'India' }
];

const CAR_BRANDS = ['Toyota', 'BMW', 'Honda', 'Ford', 'Mercedes', 'Tesla', 'Ferrari', 'Audi', 'Nissan', 'Hyundai', 'Volkswagen', 'Porsche', 'Lexus', 'Chevrolet', 'Mazda', 'Subaru', 'Kia', 'Volvo', 'Jaguar', 'Land Rover'];
const CAR_PARTS = ['Turbocharger', 'Radiator', 'Alternator', 'Fuel Injector', 'Brake Rotor', 'Brake Pad', 'Shock Absorber', 'Lowering Spring', 'Coilover', 'Alloy Wheel', 'Floor Mat', 'Racing Seat', 'Dash Cam', 'Headlight', 'Tail Light', 'Air Filter', 'Oil Filter', 'Spark Plug', 'Clutch Kit', 'Exhaust Manifold', 'Intercooler', 'Blow Off Valve', 'Strut Bar', 'Sway Bar', 'Brake Caliper', 'Steering Wheel', 'Gear Knob', 'Roof Rack', 'Spoiler', 'Diffuser'];

const MOTO_BRANDS = ['Ducati', 'Harley-Davidson', 'Yamaha', 'Kawasaki', 'Honda', 'Suzuki', 'BMW', 'Triumph', 'KTM', 'Royal Enfield', 'Aprilia', 'Moto Guzzi', 'Indian', 'Benelli', 'Husqvarna'];
const MOTO_PARTS = ['Exhaust', 'Helmet', 'Master Cylinder', 'Chain Kit', 'Sprocket', 'Rear Shock', 'Fairing', 'Handlebar', 'Mirror', 'Footpeg', 'Brake Line', 'Air Intake', 'Fuel Tank', 'Seat', 'Tire', 'Panniers', 'Crash Bars', 'Windshield', 'Radiator Guard', 'Tail Tidy', 'Brake Lever', 'Clutch Lever', 'Tank Pad', 'Engine Case Cover', 'LED Indicators'];
...
const generateProducts = () => {
    ...
    const getKeywords = (category: string, part: string, type: 'main' | 'detail' | 'side' | 'macro' = 'main') => {
        const p = part.toLowerCase();
        
        // Map specific parts to high-quality Unsplash IDs for a "real website" feel
        const unsplashMapping: Record<string, string[]> = {
            'turbocharger': ['1605559424843-9e4c228bf1c2', '1580273916550-e323be2ae537', '1517524204709-449d19fbbbd9'],
            'radiator': ['1504222490345-c075b6008014', '1585832770230-11234f218e06', '1605559424843-9e4c228bf1c2'],
            'alternator': ['1517524204709-449d19fbbbd9', '1585832770230-11234f218e06', '1605559424843-9e4c228bf1c2'],
            'brake rotor': ['1486497395442-885e218fdb67', '1584305323448-2936140031ae', '1505429853006-8913588b3e82'],
            'brake pad': ['1486497395442-885e218fdb67', '1584305323448-2936140031ae', '1505429853006-8913588b3e82'],
            'alloy wheel': ['1505429853006-8913588b3e82', '1584305323448-2936140031ae', '1549399500-5d521b4b197a'],
            'headlight': ['1549399500-5d521b4b197a', '1552519507-da3b142c6e3d', '1503376780353-7e6692767b70'],
            'exhaust': ['1580273916550-e323be2ae537', '1517524204709-449d19fbbbd9', '1558981403-c5f91cbba527'],
            'helmet': ['1558444458-5cd00bb12ee1', '1558981403-c5f91cbba527', '1558444458-5cd00bb12ee1'],
            'tire': ['1584305323448-2936140031ae', '1505429853006-8913588b3e82', '1486497395442-885e218fdb67'],
            'groupset': ['1520640530522-aa1504688697', '1532298229144-0ee0cb85a176', '1485965120184-e220f721d03e'],
            'wheelset': ['1485965120184-e220f721d03e', '1532298229144-0ee0cb85a176', '1520640530522-aa1504688697'],
            'carbon frame': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'saddle': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'pedal': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'chain': ['1520640530522-aa1504688697', '1532298229144-0ee0cb85a176', '1485965120184-e220f721d03e'],
            'fork': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'steering wheel': ['1552519507-da3b142c6e3d', '1541899481282-d53bcfcf7335', '1503376780353-7e6692767b70'],
            'gear knob': ['1541899481282-d53bcfcf7335', '1552519507-da3b142c6e3d', '1503376780353-7e6692767b70'],
            'spoiler': ['1503376780353-7e6692767b70', '1552519507-da3b142c6e3d', '1541899481282-d53bcfcf7335'],
            'spark plug': ['1585832770230-11234f218e06', '1517524204709-449d19fbbbd9', '1605559424843-9e4c228bf1c2'],
            'oil filter': ['1605559424843-9e4c228bf1c2', '1585832770230-11234f218e06', '1517524204709-449d19fbbbd9'],
            'air filter': ['1585832770230-11234f218e06', '1605559424843-9e4c228bf1c2', '1517524204709-449d19fbbbd9'],
            'racing seat': ['1542362567-b051c1f356bd', '1552519507-da3b142c6e3d', '1503376780353-7e6692767b70'],
            'dash cam': ['1600003015121-be09143bd7b8', '1552519507-da3b142c6e3d', '1541899481282-d53bcfcf7335'],
            'fuel injector': ['1585832770230-11234f218e06', '1517524204709-449d19fbbbd9', '1605559424843-9e4c228bf1c2'],
            'shock absorber': ['1486497395442-885e218fdb67', '1584305323448-2936140031ae', '1505429853006-8913588b3e82'],
            'handlebar': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'mirror': ['1552519507-da3b142c6e3d', '1558981403-c5f91cbba527', '1541899481282-d53bcfcf7335'],
            'fuel tank': ['1558981403-c5f91cbba527', '1517524204709-449d19fbbbd9', '1585832770230-11234f218e06'],
            'windshield': ['1552519507-da3b142c6e3d', '1558981403-c5f91cbba527', '1503376780353-7e6692767b70'],
            'derailleur': ['1520640530522-aa1504688697', '1532298229144-0ee0cb85a176', '1485965120184-e220f721d03e'],
            'cassette': ['1520640530522-aa1504688697', '1532298229144-0ee0cb85a176', '1485965120184-e220f721d03e'],
            'crankset': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'stem': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'headset': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'engine': ['1517524204709-449d19fbbbd9', '1585832770230-11234f218e06', '1605559424843-9e4c228bf1c2'],
            'piston': ['1517524204709-449d19fbbbd9', '1585832770230-11234f218e06', '1605559424843-9e4c228bf1c2'],
            'clutch': ['1517524204709-449d19fbbbd9', '1585832770230-11234f218e06', '1605559424843-9e4c228bf1c2'],
            'battery': ['1616422285861-92e0e952700b', '1517524204709-449d19fbbbd9', '1585832770230-11234f218e06'],
            'wheel': ['1549399500-5d521b4b197a', '1505429853006-8913588b3e82', '1486497395442-885e218fdb67'],
            'interior': ['1552519507-da3b142c6e3d', '1541899481282-d53bcfcf7335', '1503376780353-7e6692767b70'],
            'dashboard': ['1541899481282-d53bcfcf7335', '1552519507-da3b142c6e3d', '1503376780353-7e6692767b70'],
            'brake caliper': ['1486497395442-885e218fdb67', '1584305323448-2936140031ae', '1505429853006-8913588b3e82'],
            'suspension': ['1486497395442-885e218fdb67', '1584305323448-2936140031ae', '1505429853006-8913588b3e82'],
            'exhaust manifold': ['1580273916550-e323be2ae537', '1517524204709-449d19fbbbd9', '1605559424843-9e4c228bf1c2'],
            'intercooler': ['1605559424843-9e4c228bf1c2', '1585832770230-11234f218e06', '1517524204709-449d19fbbbd9'],
            'blow off valve': ['1605559424843-9e4c228bf1c2', '1585832770230-11234f218e06', '1517524204709-449d19fbbbd9'],
            'strut bar': ['1486497395442-885e218fdb67', '1584305323448-2936140031ae', '1505429853006-8913588b3e82'],
            'sway bar': ['1486497395442-885e218fdb67', '1584305323448-2936140031ae', '1505429853006-8913588b3e82'],
            'roof rack': ['1503376780353-7e6692767b70', '1552519507-da3b142c6e3d', '1541899481282-d53bcfcf7335'],
            'diffuser': ['1503376780353-7e6692767b70', '1552519507-da3b142c6e3d', '1541899481282-d53bcfcf7335'],
            'chain kit': ['1558981403-c5f91cbba527', '1517524204709-449d19fbbbd9', '1585832770230-11234f218e06'],
            'sprocket': ['1558981403-c5f91cbba527', '1517524204709-449d19fbbbd9', '1585832770230-11234f218e06'],
            'rear shock': ['1558981403-c5f91cbba527', '1486497395442-885e218fdb67', '1584305323448-2936140031ae'],
            'fairing': ['1558981403-c5f91cbba527', '1552519507-da3b142c6e3d', '1503376780353-7e6692767b70'],
            'footpeg': ['1558981403-c5f91cbba527', '1552519507-da3b142c6e3d', '1541899481282-d53bcfcf7335'],
            'brake line': ['1558981403-c5f91cbba527', '1486497395442-885e218fdb67', '1584305323448-2936140031ae'],
            'air intake': ['1517524204709-449d19fbbbd9', '1585832770230-11234f218e06', '1605559424843-9e4c228bf1c2'],
            'panniers': ['1558981403-c5f91cbba527', '1552519507-da3b142c6e3d', '1503376780353-7e6692767b70'],
            'crash bars': ['1558981403-c5f91cbba527', '1552519507-da3b142c6e3d', '1503376780353-7e6692767b70'],
            'radiator guard': ['1504222490345-c075b6008014', '1558981403-c5f91cbba527', '1585832770230-11234f218e06'],
            'tail tidy': ['1558981403-c5f91cbba527', '1552519507-da3b142c6e3d', '1503376780353-7e6692767b70'],
            'brake lever': ['1558981403-c5f91cbba527', '1486497395442-885e218fdb67', '1584305323448-2936140031ae'],
            'clutch lever': ['1558981403-c5f91cbba527', '1517524204709-449d19fbbbd9', '1585832770230-11234f218e06'],
            'tank pad': ['1558981403-c5f91cbba527', '1517524204709-449d19fbbbd9', '1585832770230-11234f218e06'],
            'engine case cover': ['1517524204709-449d19fbbbd9', '1585832770230-11234f218e06', '1605559424843-9e4c228bf1c2'],
            'led indicators': ['1558981403-c5f91cbba527', '1552519507-da3b142c6e3d', '1541899481282-d53bcfcf7335'],
            'seatpost': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'brake set': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'bottom bracket': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'thru axle': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'bar tape': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'bottle cage': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'mudguards': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'pannier rack': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'computer mount': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e'],
            'lights set': ['1532298229144-0ee0cb85a176', '1520640530522-aa1504688697', '1485965120184-e220f721d03e']
        };

        const idx = type === 'main' ? 0 : type === 'detail' ? 1 : type === 'side' ? 2 : 0;
        ...
        const c = category === 'car' ? 'automotive' : category === 'motorcycle' ? 'motorbike' : 'bicycle';
...
const App: React.FC = () => {
    ...
    const [currentPage, setCurrentPage] = useState<'marketplace' | 'orders' | 'shipping'>('marketplace');
    const [pendingShippingAddress, setPendingShippingAddress] = useState<Address | null>(null);
    ...
    const handleSaveProduct = (productData: Omit<Product, 'id' | 'sellerId' | 'sellerPhoneNumber'> | Product) => {
        if ('id' in productData && productData.id) { // Editing existing product
            setProducts(prev => prev.map(p => p.id === productData.id ? { ...p, ...productData } as Product : p));
            addToast('Item updated successfully!', 'success');
        } else { // Adding new product
            const newProduct: Product = {
                ...(productData as Omit<Product, 'id' | 'sellerId' | 'sellerPhoneNumber'>),
    ...
    const handleAddReview = (productId: number, reviewData: Omit<Review, 'id' | 'author' | 'date'>) => {
    ...
    const handleToggleWishlist = (product: Product) => {
        ...
        addToast(isInWishlist ? 'Removed from wishlist.' : 'Added to wishlist!', isInWishlist ? 'info' : 'success');
    };
    ...
    const handleConfirmOrder = (orderDetails: { id: string; items: Product[]; total: number; currency: Currency; }) => {
        ...
        setTimeout(() => {
            setOrders(prev => prev.map(o => o.id === newOrder.id ? { ...o, status: OrderStatus.SHIPPED } : o));
    ...
    const handleConfirmDelivery = (orderId: string) => {
        ...
        addToast(`Order ${orderId} completed! Final payment successful.`, 'success');
    };
    ...
    const handleSendMessage = async (conversationId: string, text: string) => {
        ...
        const replyMessage: ChatMessage = {
         ...
         setConversations(prev =>
            prev.map(c => (c.id === conversationId ? { ...c, messages: [...c.messages, replyMessage] } : c))
        );
    };
                    ...
                    >
                        ...
                        {role === 'buyer' ? (
                            ...
                            <SellerDashboard
                                ...
                                onAddNewItem={() => setIsSellModalOpen(true)}
        ...
        <div className="min-h-screen relative text-text-primary overflow-x-hidden font-sans pb-20">
            ...
            {viewedProduct && (
                <ProductDetailModal
                    ...
                    displayCurrency={displayCurrency}
                    isInWishlist={wishlistItems.some(item => item.id === viewedProduct.id)}
