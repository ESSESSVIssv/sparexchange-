...
interface ProductDetailModalProps {
  ...
  onAddReview: (
    productId: number,
    review: Omit<Review, "id" | "author" | "date">,
  ) => void;
        ...
        >
          ...
          <div className="px-6 py-4 border-b border-white/10 flex justify-between items-center bg-bg-dark/50 sticky top-0 z-20 backdrop-blur-md">
            <div>
              ...
              <p
                className="text-xs text-brand-primary font-bold uppercase tracking-wider"
          ...
          <div className="flex-grow">
              ...
              <div className="lg:col-span-5 p-6 lg:p-8 flex flex-col bg-bg-dark/30">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      <span
                        className={`inline-block px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest backdrop-blur-md ${conditionBadgeClass}`}
                      >
                        {product.condition}
                      </span>
                      {product.imageUrl.includes("unsplash.com") && (
                        <span
                          className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest bg-brand-primary/20 text-brand-primary border border-brand-primary/30 backdrop-blur-md shadow-[0_0_10px_rgba(255,107,0,0.2)]"
                          style={{ color: "var(--color-brand-primary)" }}
                        >
                          <ShieldCheck size={12} />
                          AI Verified
                ...
                <div className="space-y-8 flex-grow">
                  ...
                  <div className="bg-bg-darker/50 p-5 rounded-2xl border border-white/5">
                    <h4 className="text-[10px] font-bold text-text-muted uppercase tracking-widest mb-4 border-b border-white/5 pb-2">
                      Technical Specifications
                    </h4>
                    <div className="grid grid-cols-2 gap-y-4 gap-x-2">
                      <div>
                        <p className="text-[9px] text-text-muted font-bold uppercase mb-1 drop-shadow-sm">
                          SKU
                        </p>
                        <p className="text-xs font-mono text-white truncate">
                          {product.description.includes("SKU: ")
                            ? product.description.split("SKU: ")[1]
                            : `PART-${product.id}`}
                        </p>
                      </div>
                      <div>
                  ...
                  <div className="bg-bg-darker/50 rounded-2xl p-5 border border-white/5 relative overflow-hidden">
                    ...
                    >
                      <div className="flex items-center gap-4 mb-5 relative z-10 p-2 rounded-xl transition-colors hover:bg-white/5 pr-4 border border-transparent hover:border-white/10">
                ...
                <div className="pt-6 mt-6 border-t border-white/5">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-2xl p-4 mb-6 relative overflow-hidden">
                    <div
                      className="absolute inset-0 bg-gradient-to-r from-brand-primary/10 to-transparent pointer-events-none"
                      style={{
                        backgroundImage:
                          "linear-gradient(to right, rgba(255,107,0,0.1), transparent)",
                      }}
                    />
                    <p
                      className="text-[10px] font-bold text-brand-primary uppercase tracking-widest mb-1"
                      style={{ color: "var(--color-brand-primary)" }}
                    >
                      Flexible Payment
                    </p>
            ...
            <div className="p-6 lg:p-10 border-t border-white/5 bg-bg-darker/30">
              <div className="max-w-4xl mx-auto">
                <h4 className="text-2xl font-bold text-white mb-8 font-display">
                  Customer Reviews
                </h4>

                <div className="bg-white/5 p-6 md:p-8 rounded-3xl border border-white/10 mb-10 relative overflow-hidden">
                  <div
                    className="absolute -top-24 -right-24 w-48 h-48 bg-brand-primary/10 rounded-full blur-3xl pointer-events-none"
                    style={{ backgroundColor: "rgba(255,107,0,0.1)" }}
                  />
                  <h5 className="text-sm font-bold text-white mb-6 uppercase tracking-wider relative z-10">
                    Write a Review
                  </h5>
                  <form
                  ...
                  {reviews.length > 0 ? (
                    reviews.map((review) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-text-secondary leading-relaxed pl-14">
                          {review.comment}
                        </p>
                      </motion.div>
                    ))
