      ...
      <div className="container mx-auto glass-panel rounded-2xl px-6 py-4 flex justify-between items-center shadow-2xl">
        ...
        >
          ...
          <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-gradient font-display">
            ...
            {role === "seller" && (
              <span
                className="text-sm font-medium text-brand-primary ml-3"
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          >
            ...
            {chatCount > 0 && (
              <span
                className="absolute top-0 right-0 flex h-5 w-5 items-center justify-center rounded-full bg-brand-primary text-[10px] font-bold text-white transform translate-x-1/4 -translate-y-1/4"
          ...
          >
            ...
            <span className="hidden sm:inline">
              {role === "buyer" ? "Sell Your Item" : "Add New Item"}
            </span>
          </motion.button>
        </div>
      </div>
